      ...
      return (
        ...
        >
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 rounded-lg bg-surface-700 border border-surface-600 text-sm text-slate-300 hover:bg-surface-600 hover:text-white transition-colors duration-200"
          >
