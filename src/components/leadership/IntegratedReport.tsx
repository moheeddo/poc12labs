  ...
  return (
    <div className="bg-white/70 border border-slate-200/50 rounded-2xl p-5 print:border-slate-300">
      <SectionHeader
        ...
        subtitle="역량 강점(emerald)과 탈선 위험도(amber) 통합 시각화"
        accent="emerald"
      />
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-3 mt-1">
                    ...
                    <div className="flex items-center gap-1.5 flex-1 min-w-0">
                      ...
                      <span className="text-[10px] font-mono font-medium text-emerald-700 shrink-0">
                        {coveragePct}%
                      </span>
                    </div>
                  </div>
                ...
                <div className="px-4 py-2 flex flex-wrap gap-1.5 max-h-24 overflow-y-auto">
                  {em.clips.map((clip, idx) => (
                    <button
                      ...
                      className="inline-flex items-center gap-1 text-[10px] font-mono text-emerald-700 bg-emerald-50 hover:bg-emerald-100 border border-emerald-200 rounded px-1.5 py-1 min-h-[28px] transition-colors whitespace-nowrap"
            ...
            >
              ...
              <div className="px-4 py-3">
                ...
                <button
                  ...
                  className="mt-2 inline-flex items-center gap-1 text-[10px] font-mono text-emerald-700 bg-emerald-50 hover:bg-emerald-100 border border-emerald-200 rounded px-1.5 py-1 min-h-[28px] transition-colors"
                >
        ...
        <div className="mt-4 pt-3 border-t border-slate-100/60">
          ...
          <div className="flex flex-wrap gap-1.5">
            {beiAnalysis.differentiatingCompetencies.map((key) => (
              <span
                key={key}
                className="inline-flex items-center gap-1 text-[10px] font-medium bg-emerald-100 text-emerald-700 border border-emerald-300 rounded-full px-2 py-0.5"
              >
            ...
            <div key={key}>
              ...
              <div className="relative h-3 bg-slate-100/80 rounded-full overflow-visible">
                ...
                <div className="absolute inset-0 flex rounded-full overflow-hidden">
                  ...
                  <div className="w-[25%] bg-emerald-200/60" />
                  <div className="w-[15%] bg-emerald-300/60" />
                  <div className="w-[10%] bg-emerald-400/60" />
                </div>
                {/* P50 중앙선 */}
                ...
                {score > 0 && (
                  <div
                    className="absolute top-1/2 -translate-y-1/2 -translate-x-1/2 w-3 h-3 rounded-full bg-emerald-600 border-2 border-white shadow-sm z-10"
...
function CoachingSection({
  ...
  function PreviousBadge({ competencyKey }: { competencyKey: string }) {
    ...
    if (comparedToPrevious.improved.includes(competencyKey)) {
      return (
        <span className="inline-flex items-center gap-0.5 text-[10px] font-medium bg-emerald-100 text-emerald-700 border border-emerald-300 rounded-full px-1.5 py-0.5 ml-1">
          ...
          <div className="space-y-2">
            {strengths.length === 0 ? (
              ...
              strengths.map((s, i) => (
                <div
                  key={i}
                  className="border-l-2 border-emerald-500 bg-emerald-50/60 rounded-r-xl px-3 py-2.5"
                >
