        ...
        <div className="px-4 pb-4 pt-1 space-y-3 border-t border-violet-100/60">
          ...
          <div>
            ...
            <input
              ...
              className="w-full bg-white border border-slate-200 rounded-lg px-3 py-2 text-sm text-slate-900 placeholder:text-slate-400 outline-none focus:border-teal-500/40 focus:ring-1 focus:ring-teal-500/15"
            />
          </div>
            ...
            <div>
              ...
              <div className="flex items-center gap-1.5">
                <input
                  ...
                  className="flex-1 bg-white border border-slate-200 rounded-lg px-3 py-2 text-sm text-slate-900 placeholder:text-slate-400 outline-none focus:border-teal-500/40 focus:ring-1 focus:ring-teal-500/15"
                />
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-1.5 mb-1.5">
              {glossary.map((t) => (
                <span key={t} className="inline-flex items-center gap-1 text-xs bg-teal-50 text-teal-700 rounded-md px-2 py-1">
                  {t}
