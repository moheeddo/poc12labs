...
const FOOTER_LINKS: { key: ServiceTab; label: string; color: string }[] = [
  { key: "leadership", label: "리더십 - 역량진단 2.0", color: "hover:text-emerald-700" },
];
...
export default function Footer({ onNavigate }: FooterProps) {
  return (
    <footer className="border-t border-slate-200 no-print">
      {/* 멀티컬러 디바이더 */}
      <div className="h-px bg-gradient-to-r from-khnp-emerald/20 via-khnp-emerald-light/15 to-khnp-emerald/20" />
